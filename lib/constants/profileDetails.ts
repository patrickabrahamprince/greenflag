...
export const TEASER_PROMPTS = [
  'Next on my travel bucket list is',
  'My favorite travel memory is',
  'A green flag in a travel buddy is',
  'My ideal weekend getaway looks like',
  'I will convince you to visit',
  'My go-to road trip song is',
  'The best sunrise or sunset spot I know is',
  'A random fact I love is',
  'My ideal Sunday looks like',
  'I will never shut up about',
  'My most controversial opinion is',
  'I know the best cafe or street food spot for',
  'My friends would describe me as',
  'Two truths and a lie',
  'A skill I am low-key proud of is',
];
