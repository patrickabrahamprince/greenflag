...
export function OtpVerificationForm({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <input type="tel" placeholder="Enter Verification Code" value={otp} onChange={e => onOtpChange(e.target.value.replace(/\D/g, '').slice(0, 6))} required maxLength={6} className="input text-center text-lg tracking-[0.3em]" />
