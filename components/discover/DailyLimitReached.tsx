...
export function DailyLimitReached() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] px-6 text-center">
      <div className="w-20 h-20 rounded-full bg-well flex items-center justify-center mb-6">
      ...
      <div className="bg-well rounded-xl px-6 py-3">
        <p className="text-xs text-ink/50 mb-1">Resets in</p>
