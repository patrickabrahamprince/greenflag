      ...
      <div className="card max-w-md w-full p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-display text-[#EDEADE]">Reject Application</h3>
          </div>
        ...
        <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-4 mb-4">
          <p className="text-sm text-red-400 font-medium mb-1">You are rejecting:</p>
          <p className="text-[#EDEADE] font-medium">{user.name} ({user.email})</p>
        </div>

        <div className="mb-4">
          <label className="block text-sm text-[#8E8E93] mb-2">Reason for rejection *</label>
          <textarea
